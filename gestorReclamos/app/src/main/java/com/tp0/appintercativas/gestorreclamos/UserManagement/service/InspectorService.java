...
public interface InspectorService {
    ...
    public final String API_ROUTE = "/api/inspectores";
    @POST(API_ROUTE)
    ...
    public final String API_ROUTE_BYID = "/api/inspectores/{id}";
    @GET(API_ROUTE_BYID)
    Call<Inspector> findBYId(@Path("id") long id);

    public final String API_ROUTE_GETBYID = "/api/inspectores/getId";
    @Headers({
