    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.reclamoactivo:
                ...
                intent = new Intent(activity_nreclamo4.this, activity_areclamo1.class);
            ...
            case R.id.notificaciones:
                ...
                intent = new Intent(activity_nreclamo4.this, activity_notificaciones1.class);
                startActivity(intent);
                break;
            case R.id.usuarios:
                Toast.makeText(this, "Usuarios selected", Toast.LENGTH_SHORT).show();
                intent = new Intent(activity_nreclamo4.this, activity_adminuser1.class);
                startActivity(intent);
                break;
