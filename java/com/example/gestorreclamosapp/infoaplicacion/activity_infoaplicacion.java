    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.reclamonuevo:
                ...
                intent = new Intent(activity_infoaplicacion.this, activity_nreclamo1.class);
                startActivity(intent);
                break;
            case R.id.reclamoactivo:
                Toast.makeText(this, "Reclamos Activos selected", Toast.LENGTH_SHORT).show();
                intent = new Intent(activity_infoaplicacion.this, activity_areclamo1.class);
                startActivity(intent);
                break;
            ...
            case R.id.usuarios:
                ...
                intent = new Intent(activity_infoaplicacion.this, activity_adminuser1.class);
                startActivity(intent);
                break;
