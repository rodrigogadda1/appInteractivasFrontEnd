...
public class activity_nreclamo2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, DrawerLayout.DrawerListener {
...
public boolean onNavigationItemSelected(MenuItem item) {
        ...
        case R.id.reclamohistorial:
            ...
            intent = new Intent(activity_nreclamo2.this, activity_hreclamo.class);
            startActivity(intent);
            break;
        ...
        case R.id.usuarios:
            ...
            intent = new Intent(activity_nreclamo2.this, activity_adminuser1.class);
            startActivity(intent);
            break;
        case R.id.datospersonales:
            Toast.makeText(this, "Datos Personales selected", Toast.LENGTH_SHORT).show();
            intent = new Intent(activity_nreclamo2.this, activity_datospers.class);
            startActivity(intent);
            break;
        case R.id.configuracion:
            Toast.makeText(this, "Configuraciones selected", Toast.LENGTH_SHORT).show();
            intent = new Intent(activity_nreclamo2.this, activity_configuraciones.class);
            startActivity(intent);
            break;
        case R.id.acercaapp:
            Toast.makeText(this, "Acerca de la App selected", Toast.LENGTH_SHORT).show();
            intent = new Intent(activity_nreclamo2.this, activity_infoaplicacion.class);
            startActivity(intent);
            break;
        case R.id.cerrarsesion:
            Toast.makeText(this, "Cerrar Sesión selected", Toast.LENGTH_SHORT).show();
            intent = new Intent(activity_nreclamo2.this, LoginActivity.class);
            startActivity(intent);
            break;
        default:
            break;
