package com.example.gestorreclamosapp.areclamo2;
...
import com.example.gestorreclamosapp.areclamo3.activity_areclamo3;
...
public class activity_areclamo2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, DrawerLayout.DrawerListener {
    private DrawerLayout drawerLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_areclamo2);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.reclamonuevo:
                ...
                intent = new Intent(activity_areclamo2.this, activity_nreclamo1.class);
            ...
            case R.id.reclamohistorial:
                ...
                intent = new Intent(activity_areclamo2.this, activity_hreclamo.class);
                startActivity(intent);
                break;
            case R.id.notificaciones:
                Toast.makeText(this, "Notificaciones selected", Toast.LENGTH_SHORT).show();
                intent = new Intent(activity_areclamo2.this, activity_notificaciones1.class);
                startActivity(intent);
                break;
            case R.id.usuarios:
                Toast.makeText(this, "Usuarios selected", Toast.LENGTH_SHORT).show();
                intent = new Intent(activity_areclamo2.this, activity_adminuser1.class);
                startActivity(intent);
                break;
            case R.id.datospersonales:
                Toast.makeText(this, "Datos Personales selected", Toast.LENGTH_SHORT).show();
                intent = new Intent(activity_areclamo2.this, activity_datospers.class);
                startActivity(intent);
                break;
            case R.id.configuracion:
                Toast.makeText(this, "Configuraciones selected", Toast.LENGTH_SHORT).show();
                intent = new Intent(activity_areclamo2.this, activity_configuraciones.class);
                startActivity(intent);
                break;
            case R.id.acercaapp:
                Toast.makeText(this, "Acerca de la App selected", Toast.LENGTH_SHORT).show();
                intent = new Intent(activity_areclamo2.this, activity_infoaplicacion.class);
                startActivity(intent);
                break;
            case R.id.cerrarsesion:
                Toast.makeText(this, "Cerrar Sesión selected", Toast.LENGTH_SHORT).show();
                intent = new Intent(activity_areclamo2.this, LoginActivity.class);
                startActivity(intent);
                break;
            default:
                break;
    ...
    public void back(View view) {
        Intent intent = new Intent(activity_areclamo2.this, activity_areclamo1.class);
        startActivity(intent);
    }
    public void exit(View view) {
        Intent intent = new Intent(activity_areclamo2.this, activity_principal.class);
        startActivity(intent);
    }
    public void next(View view) {
        Intent intent = new Intent(activity_areclamo2.this, activity_areclamo3.class);
        startActivity(intent);
    }
